...
// Enum values for intrinsics.
    ...
    dx_discard,                                // llvm.dx.discard (IntrinsicsDirectX.td:169)
    ...
    dx_firstbitlow,                            // llvm.dx.firstbitlow (IntrinsicsDirectX.td:172)
    dx_firstbitshigh,                          // llvm.dx.firstbitshigh (IntrinsicsDirectX.td:171)
    dx_firstbituhigh,                          // llvm.dx.firstbituhigh (IntrinsicsDirectX.td:170)
    ...
    dx_group_memory_barrier_with_group_sync,   // llvm.dx.group.memory.barrier.with.group.sync (IntrinsicsDirectX.td:174)
    dx_imad,                                   // llvm.dx.imad (IntrinsicsDirectX.td:146)
    dx_isinf,                                  // llvm.dx.isinf (IntrinsicsDirectX.td:138)
    dx_isnan,                                  // llvm.dx.isnan (IntrinsicsDirectX.td:140)
    dx_lerp,                                   // llvm.dx.lerp (IntrinsicsDirectX.td:143)
    dx_nclamp,                                 // llvm.dx.nclamp (IntrinsicsDirectX.td:91)
    dx_normalize,                              // llvm.dx.normalize (IntrinsicsDirectX.td:148)
    dx_radians,                                // llvm.dx.radians (IntrinsicsDirectX.td:168)
    ...
    dx_rsqrt,                                  // llvm.dx.rsqrt (IntrinsicsDirectX.td:149)
    ...
    dx_sign,                                   // llvm.dx.sign (IntrinsicsDirectX.td:164)
    dx_splitdouble,                            // llvm.dx.splitdouble (IntrinsicsDirectX.td:166)
    dx_step,                                   // llvm.dx.step (IntrinsicsDirectX.td:165)
    ...
    dx_umad,                                   // llvm.dx.umad (IntrinsicsDirectX.td:147)
    dx_wave_active_countbits,                  // llvm.dx.wave.active.countbits (IntrinsicsDirectX.td:150)
    dx_wave_all,                               // llvm.dx.wave.all (IntrinsicsDirectX.td:151)
    dx_wave_any,                               // llvm.dx.wave.any (IntrinsicsDirectX.td:152)
    dx_wave_get_lane_count,                    // llvm.dx.wave.get.lane.count (IntrinsicsDirectX.td:162)
    dx_wave_getlaneindex,                      // llvm.dx.wave.getlaneindex (IntrinsicsDirectX.td:153)
    dx_wave_is_first_lane,                     // llvm.dx.wave.is.first.lane (IntrinsicsDirectX.td:160)
    dx_wave_readlane,                          // llvm.dx.wave.readlane (IntrinsicsDirectX.td:161)
    dx_wave_reduce_max,                        // llvm.dx.wave.reduce.max (IntrinsicsDirectX.td:154)
    dx_wave_reduce_min,                        // llvm.dx.wave.reduce.min (IntrinsicsDirectX.td:156)
    dx_wave_reduce_sum,                        // llvm.dx.wave.reduce.sum (IntrinsicsDirectX.td:158)
    dx_wave_reduce_umax,                       // llvm.dx.wave.reduce.umax (IntrinsicsDirectX.td:155)
    dx_wave_reduce_umin,                       // llvm.dx.wave.reduce.umin (IntrinsicsDirectX.td:157)
    dx_wave_reduce_usum,                       // llvm.dx.wave.reduce.usum (IntrinsicsDirectX.td:159)
}; // enum
} // namespace llvm::Intrinsic
#endif
